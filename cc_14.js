...
function createHPTicketCard(name, issue, id) { // function to create employee card
    const newCard = document.createElement("div") // create div tag
    newCard.setAttribute("class", "high-priority-ticket-card") // set id
    ...
    ticketLabel.textContent = "High Priority"
...
function createMPTicketCard(name, issue, id) { // function to create employee card
    const newCard = document.createElement("div") // create div tag
    newCard.setAttribute("class", "medium-priority-ticket-card") // set css class
    newCard.setAttribute("id", id) // set id
    ...
    const ticketLabel = document.createElement("label")
    ticketLabel.textContent = "Medium Priority"
...
function createLPTicketCard(name, issue, id) { // function to create employee card
    const newCard = document.createElement("div") // create div tag
    newCard.setAttribute("class","low-priority-ticket-card") // set css class
    newCard.setAttribute("id", id) // set id
    ...
    const ticketLabel = document.createElement("label")
    ticketLabel.textContent = "Low Priority"
...
createHPTicketCard("Jason Miller", "Billing Issue", "ticket1") // creation of ticket1
createMPTicketCard("Galo Rebelo", "Return Policy", "ticket2") // creation of ticket2
createLPTicketCard("Eric Torres", "Product Damage", "ticket3") // creation of ticket3
